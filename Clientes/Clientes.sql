...
SELECT * FROM paqueteria.paquetes; 
...
---Paquetes----
INSERT INTO `paqueteria`.`paquetes` (`idPaquete`, `Peso`, `Dimension`) VALUES ('1', '3', 'Grande');
INSERT INTO `paqueteria`.`paquetes` (`idPaquete`, `Peso`, `Dimension`) VALUES ('2', '2', 'Mediano');
INSERT INTO `paqueteria`.`paquetes` (`idPaquete`, `Peso`, `Dimension`) VALUES ('3', '1', 'Chico');
INSERT INTO `paqueteria`.`paquetes` (`idPaquete`, `Peso`, `Dimension`) VALUES ('4', '6', 'Grande');
INSERT INTO `paqueteria`.`paquetes` (`idPaquete`, `Peso`, `Dimension`) VALUES ('5', '3', 'Mediano');

  
update  paqueteria.paqueteempresa SET idEmpresa = '1' where idEmpresa = '1';
---PaqueteEmpresa----
INSERT INTO `paqueteria`.`paqueteempresa` (`idPaqueteEmpresa`, `idPaquete`, `idEmpresa`) VALUES ('1', '1', '1');
INSERT INTO `paqueteria`.`paqueteempresa` (`idPaqueteEmpresa`, `idPaquete`, `idEmpresa`) VALUES ('2', '2', '2');
INSERT INTO `paqueteria`.`paqueteempresa` (`idPaqueteEmpresa`, `idPaquete`, `idEmpresa`) VALUES ('3', '3', '3');
INSERT INTO `paqueteria`.`paqueteempresa` (`idPaqueteEmpresa`, `idPaquete`, `idEmpresa`) VALUES ('4', '4', '4');
INSERT INTO `paqueteria`.`paqueteempresa` (`idPaqueteEmpresa`, `idPaquete`, `idEmpresa`) VALUES ('5', '5', '5');

  
  
  
select paqueteria.empresa.idEmpresa, paqueteria.empresa.nombre, paqueteria.empresa.direccion, 
paqueteria.paquetes.idPaquete, paqueteria.paquetes.Peso, paqueteria.paquetes.Dimension 
from paqueteempresa inner join paqueteria.empresa, paqueteria.paquetes 
where paqueteria.paqueteempresa.idEmpresa =  paqueteria.empresa.idEmpresa
and paqueteria.paqueteempresa.idPaquete = paqueteria.paquetes.idPaquete; 
...
ADD CONSTRAINT `FK_idPaquete`
  ...
  REFERENCES `paqueteria`.`paquetes` (`idPaquete`)
  ON DELETE NO ACTION
  ON UPDATE NO ACTION,
