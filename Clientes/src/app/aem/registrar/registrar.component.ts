...
import {EmpleadoService, Departamento, Equipo, Roles} from "../../services/empleado.service";
...
nacimiento:any;
  ...
  //delete this.equipo.id_usuario;
    ...
    this.EmpleadoService.addEquipo(this.equipo).subscribe();
...
myGroup:any;
  ...
  onSelected(e:any): void {
    this.equipo.id_departamento=e.target.value;
  }
  onSelectedRoles(e:any): void {
    this.equipo.id_rol=e.target.value;
  }
  onSelectedSexo(e:any): void {
    this.equipo.sexo=e.target.value;
  }
  f='F';
  m='M';
}
